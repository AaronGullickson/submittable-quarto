---
title: "Demo of the Submittable Format"
format:
  submittable-pdf:
    keep-tex: false
    endnotes: true
  ...
  - name: John Doe
    ...
    affiliations:
      - id: uni
        ...
        department: Department of Cool
      - id: uni-another
        name: Neato Institute
...
if(!require(palmerpenguins)) {
  install.packages("palmerpenguines")
  library(palmerpenguins)
}
```

```{r}
style_gt_table <- function(gt_table) {
  gt_table |>
    tab_options(
      table.font.size = 11,
